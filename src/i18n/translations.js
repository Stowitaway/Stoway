...
export const translations = {
  en: {
    ...
    modal: {
      ...
      addressPlaceholder: "e.g. Rua de São Miguel 12",
      addressPrivacyHint: "Your exact address is never stored or shown — only an approximate pin on the map.",
      addressNotFound: "We couldn't find this address. Please check it and try again.",
  ...
  pt: {
    ...
    modal: {
      ...
      fieldAddress: "Morada",
      addressPlaceholder: "ex. Rua de São Miguel 12",
      addressPrivacyHint: "A sua morada exata nunca é guardada nem mostrada — apenas um marcador aproximado no mapa.",
      addressNotFound: "Não conseguimos encontrar esta morada. Verifique e tente novamente.",
  ...
  de: {
    ...
    modal: {
      ...
      addressPlaceholder: "z. B. Rua de São Miguel 12",
      addressPrivacyHint: "Deine genaue Adresse wird nie gespeichert oder angezeigt — nur eine ungefähre Markierung auf der Karte.",
      addressNotFound: "Diese Adresse konnten wir nicht finden. Bitte prüfen und erneut versuchen.",
  ...
  it: {
    ...
    modal: {
      ...
      addressPlaceholder: "es. Rua de São Miguel 12",
      addressPrivacyHint: "Il tuo indirizzo esatto non viene mai salvato né mostrato — solo un indicatore approssimativo sulla mappa.",
      addressNotFound: "Non siamo riusciti a trovare questo indirizzo. Verifica e riprova.",
  ...
  fr: {
    ...
    modal: {
      ...
      fieldAddress: "Adresse",
      addressPlaceholder: "ex. Rua de São Miguel 12",
      addressPrivacyHint: "Votre adresse exacte n'est jamais enregistrée ni affichée — seulement un repère approximatif sur la carte.",
      addressNotFound: "Nous n'avons pas trouvé cette adresse. Vérifiez-la et réessayez.",
